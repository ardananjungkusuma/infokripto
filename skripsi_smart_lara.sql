...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2022 at 09:39 AM
...
--
ALTER TABLE `crypto_wallet`
  MODIFY `id_wallet` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `wallet_coin`
  MODIFY `id_wallet_coin` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=182;

--
-- AUTO_INCREMENT for table `wallet_network`
--
ALTER TABLE `wallet_network`
  MODIFY `id_wallet_network` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
