        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-right">
                    <div class="card">
                        <div class="card-img">
                            <img src="{{ asset('assets/home/img/services-1.jpg') }}" alt="...">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
                    <div class="card">
                        <div class="card-img">
                            <img src="{{ asset('assets/home/img/services-2.jpg') }}" alt="...">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-right">
                    <div class="card">
                        <div class="card-img">
                            <img src="{{ asset('assets/home/img/services-3.jpg') }}" alt="...">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-left">
                    <div class="card">
                        <div class="card-img">
                            <img src="{{ asset('assets/home/img/services-4.jpg') }}" alt="...">
                        </div>
                        <div class="card-body">
        ...
        <div class="container">
            ...
            <div class="row content">
                <div class="col-md-5" data-aos="fade-right">
                    <img src="{{ asset('assets/home/img/features-1.svg') }}" class="img-fluid" alt="">
                </div>
            ...
            <div class="row content">
                <div class="col-md-5 order-1 order-md-2" data-aos="fade-left">
                    <img src="{{ asset('assets/home/img/features-2.svg') }}" class="img-fluid" alt="">
                </div>
            ...
            <div class="row content">
                <div class="col-md-5" data-aos="fade-right">
                    <img src="{{ asset('assets/home/img/features-3.svg') }}" class="img-fluid" alt="">
                </div>
            ...
            <div class="row content">
                <div class="col-md-5 order-1 order-md-2" data-aos="fade-left">
                    <img src="{{ asset('assets/home/img/features-4.svg') }}" class="img-fluid" alt="">
                </div>
                <div class="col-md-7 pt-5 order-2 order-md-1" data-aos="fade-right">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="member" data-aos="fade-up">
                        <div class="pic"><img src="{{ asset('assets/home/img/team/team-1.jpg') }}" alt=""></div>
                        <h4>Walter White</h4>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="member" data-aos="fade-up" data-aos-delay="100">
                        <div class="pic"><img src="{{ asset('assets/home/img/team/team-2.jpg') }}" alt=""></div>
                        <h4>Sarah Jhinson</h4>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="member" data-aos="fade-up" data-aos-delay="200">
                        <div class="pic"><img src="{{ asset('assets/home/img/team/team-3.jpg') }}" alt=""></div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="member" data-aos="fade-up" data-aos-delay="300">
                        <div class="pic"><img src="{{ asset('assets/home/img/team/team-4.jpg') }}" alt=""></div>
                        <h4>Amanda Jepson</h4>
